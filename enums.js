...
global.Requires = {
    ...
    VIP:        { val: 1, status: "VIP", check: function(pUser){ return pUser.isVip || pUser.isMod || pUser.isSuperUser || pUser.isOwner; }},
    Moderator:  { val: 2, status: "Moderator", check: function(pUser){ return pUser.isMod || pUser.isSuperUser || pUser.isOwner; } },
    SuperUser:  { val: 3, status: "SuperUser", check: function(pUser){ return pUser.isSuperUser || pUser.isOwner; } },
